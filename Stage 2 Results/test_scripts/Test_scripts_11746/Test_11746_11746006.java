...
public class Test_11746_11746006 {
    ...
    public void testUiTestHeaderNavigation() throws InterruptedException {
        ...
        // Assert that we are back on the previous screen
        Espresso.onView(allOf(withContentDescription("Navigate up"))).check(matches(isDisplayed()));
    }
}