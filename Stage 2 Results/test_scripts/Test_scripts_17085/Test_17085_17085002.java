...
public class Test_17085_17085002 {
    ...
    public void testSearchFunctionalityWithInvalidInput() throws InterruptedException {
        ...
        Espresso.onView(ViewMatchers.withText("")).inRoot(ViewMatchers.withClassName(
        ...
        onView(ViewMatchers.withText("Please enter a valid area or zipcode"))
                .inRoot(ViewMatchers.withClassName("android.widget.Toast"))
