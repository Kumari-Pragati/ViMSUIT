...
public class Test_14143_1414306 {

    @Rule
    public ActivityTestRule<MainActivity> activityRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void testRegressionTestEnsureTheAlreadyAMemberButtonLeadsToTheLoginScreen() throws InterruptedException {
        ...
        Thread.sleep(500);
        Espresso.onView(hasDesc("Login")).check(matches(isDisplayed()));
    }
}