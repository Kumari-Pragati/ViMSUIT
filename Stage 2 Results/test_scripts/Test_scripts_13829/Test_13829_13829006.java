...
public class Test_13829_13829006 {
    ...
    @Test
    public void testLoginWithFacebookUsabilityTest() throws InterruptedException {
        // Step 1: Open the Drug Index app (Assuming it's already open)
        ...
        // Expected Result: The user can easily log in using their Facebook credentials.
        Espresso.onView(withId(R.id.id_gdp_dialog_continue_button))
