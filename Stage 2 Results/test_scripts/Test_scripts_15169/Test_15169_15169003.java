...
public class Test_15169_15169003 {
    ...
    public void testNegativeFlowInvalidDateSelection() throws InterruptedException {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            Espresso.pressKey(ViewActions.keyEvent(KeyEvent.KEYCODE_DPAD_DOWN));
            ...
            Thread.sleep(500);
            Espresso.pressKey(ViewActions.keyEvent(KeyEvent.KEYCODE_1));
            Espresso.pressKey(ViewActions.keyEvent(KeyEvent.KEYCODE_DPAD_CENTER));
            Thread.sleep(500);
            ...
            onView(ViewMatchers.withText("Invalid date selection"))
