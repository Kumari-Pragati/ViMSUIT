...
public class Test_16886_16886005 {

    @Rule
    public ActivityTestRule<MainActivity> activityRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void testVerifyTheAvailabilityTableIsDisplayedCorrectly() throws InterruptedException {
        // Step 1: Open the app and navigate to the property listing screen.
        Thread.sleep(500); // Wait for the app to initialize

        // Step 2: Verify the availability table is displayed correctly.
